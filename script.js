...
(function() {
    ...
    window.submitPost = function() {
        ...
        if (feedPosts.length > prevLen && dbReady) {
    ...
    window.submitCommunityPost = function(commId) {
        ...
        _origSubmitCommunityPost(commId);
        if (communityPosts[commId] && communityPosts[commId].length > prevLen && dbReady) {
    ...
    window.deleteFeedPost = function(postId) {
        ...
        if (post && dbReady) dbSyncPost(post, true);
    };
    ...
    window.deleteCommunityPost = function(commId, postId) {
        ...
        if (post && dbReady) dbSyncCommunityPost(post, true);
    };
    ...
    window.likeCommunityPost = function(commId, postId) {
        ...
        if (dbReady && communityPosts[commId]) {
    ...
    window.addCommunity = function() {
        ...
        _origAddCommunity();
        if (communities.length > prevLen && dbReady) {
    ...
    window.deleteCommunity = function(commId) {
        ...
        if (comm && dbReady) {
            ...
            sbDelete('community_posts', 'community_id', commId);
        }
    };
